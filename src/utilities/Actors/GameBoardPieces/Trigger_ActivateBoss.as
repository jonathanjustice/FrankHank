package utilities.Actors.GameBoardPieces{
	...
	public class Trigger_ActivateBoss extends SelectableActor{
		...
		public function Trigger_ActivateBoss(newX:int, newY:int, newWidth:Number, newHeight:Number) {
			//print("wewewewewe");
		...
		*/}
		...
		public override function onTakeDamage():void {
			...
			Game.setGameState("activateBoss", cutSceneName);
		...
		public function assignGraphic(graphic:DisplayObject):void {
			...
			this.visible = false;
			addActorToGameEngine(graphic, LevelManager.triggers_activateBosses);
			graphic = hitbox;
		}
